# Core deck, speaker notes, appendix, and omission
...
Use notes when material is necessary for delivery but better heard than seen:

- transitions between slides;
- a short anecdote or example;
- pronunciation or presenter reminders;
- nuance that would clutter the visual;
- optional phrasing tailored to audience reaction.

Do not place critical evidence, definitions, risks, or the only explanation of a chart in notes.

## Appendix

Use appendix slides for foreseeable questions and verification:

- detailed methodology and definitions;
- full tables or segment breakdowns;
- sensitivity, robustness, and scenario analysis;
- alternative options and rejected designs;
- detailed implementation plans;
- glossary and technical architecture;
- supplementary examples and historical context.

An appendix slide must answer a plausible trigger question. If no one can name the question, omit the slide.
...
- Use stable IDs such as A1, A2, B1.
- Use question-answer or proposition titles.
- Add an appendix index when large.
- Add core-to-appendix references when the audience is likely to ask.
- Keep source notes and definitions on the appendix slide.

### Keep it self-contained

Appendix slides may be denser, but they still need:

- a clear answer or message;
- enough context to interpret the evidence;
- legible text and charts;
- traceable sources;
- a link back to the relevant core claim.
