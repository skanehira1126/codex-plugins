...
- Include the transition, intended speaking beat, optional example, and appendix cue.
- Keep notes consistent with visible claims and evidence.
- Do not hide critical content in notes.

## Appendix

- Use stable IDs and message-bearing titles.
- Include trigger question, core link, definition, and source where useful.
- Keep denser content legible and self-contained.
- Add navigation when the appendix is large.

## Render and filmstrip QA

Before delivery:

1. Render every slide to images or preview the actual deck.
