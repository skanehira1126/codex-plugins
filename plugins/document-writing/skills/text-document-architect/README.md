...
2. 説明・断定だけを連続させず、読者の認知動作を切り替える。
3. 長文を一度で書き切らず、骨格、推論、根拠、メリハリ、圧縮の段階に分ける。
4. 候補情報を、本文、表／コールアウト、注記、Appendix、削除へ振り分ける。
5. 結論を変え得るリスクや前提をAppendixへ隠さない。
6. Word等では編集可能な原本を維持し、PDFやレンダリング画像は検品・配布に使う。
